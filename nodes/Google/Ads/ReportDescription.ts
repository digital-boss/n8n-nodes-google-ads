		...
		options: [
			{
				name: 'Get',
				value: 'get',
				description: 'Return the ads data',
			},
		],
		default: 'get',
...
export const reportFields = [
	{
		...
		placeholder: '123456',
		description: 'The View ID of Google Ads',
	},
	{
				...
				options: [
					{
						...
						values: [
							...
							// https://developers.google.com/ads/devguides/reporting/core/v4/rest/v4/reports/batchGet#Operator
							{
							...
							},
							{
								...
								description: `String or <a href="https://support.google.com/ads/answer/1034324?hl=en">regular expression</a> to match against.`,
							},
						],
					},
				],
